      ...
      <section className="py-20 px-6 bg-gradient-to-b from-cream to-cream-light">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[
              { no: 2, title: 'Tehdit', desc: 'Blokları tanıyın ve salın' },
              { no: 3, title: 'İtiş-Çekiş', desc: 'Enerji dengesi kurumun' },
              { no: 4, title: 'Devir', desc: 'Eski kalıpları dönüştürün' },
              { no: 5, title: 'Niyet', desc: 'Yeni vizyonunuzu kristalleştirin' },
            ].map((seans, idx) => (
              <motion.div
                key={idx}
                initial={{ opacity: 0, scale: 0.9 }}
