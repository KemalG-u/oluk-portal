          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative aspect-square rounded-2xl overflow-hidden shadow-2xl">
                <Image alt={ders1Visuals.bakgecFelsefe.alt}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="relative aspect-[9/16]">
                  <Image alt={ders1Visuals.aurikKatman.alt}
              ...
              >
                <div className="relative aspect-[9/16]">
                  <Image alt={ders1Visuals.adimSifa.alt}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl mb-8">
                <Image alt={ders1Visuals.chakraSistem.alt}
        ...
        <section className="py-20 px-6 bg-teal/5">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl mb-8">
                <Image alt={ders1Visuals.aktivasyonAkis.alt}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                <div className="relative aspect-square overflow-hidden">
                  <Image alt={ders1Visuals.menzilKapak.alt}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <div className="relative aspect-square max-w-md mx-auto mb-8 rounded-full overflow-hidden">
                <Image alt={ders1Visuals.muhurKapani.alt}
