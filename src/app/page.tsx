    ...
    <main>
      ...
      <section className="relative py-32 px-8 bg-cream-light overflow-hidden">
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Kırık ayna değil, tam suret.", text: "Tesadüf yok. Tertip var. Başı belli, sonu aydınlık." },
              { title: "Seyretmek yok. Yaşamak var.", text: "Satırda kalmaz, sadra şifa olur." },
              { title: "Yol uzun. Ama tenhada yürümüyorsun.", text: "Binlerce nefes, tek bir niyet. Omuz omuza." },
              { title: "Otuz yılın imbiğinden süzüldü.", text: "Posası atıldı. Özü kaldı. Sana uzanan bir el." }
            ].map((feature, i) => (
              <div key={i} className="reveal p-10 bg-cream rounded-xl border-l-4 border-gold transition-all duration-400 hover:shadow-[0_25px_50px_rgba(13,79,79,0.1)] hover:-translate-y-1.5 relative overflow-hidden after:absolute after:top-0 after:right-0 after:w-[100px] after:h-[100px] after:bg-[radial-gradient(circle,_rgba(201,169,98,0.1)_0%,_transparent_70%)] after:pointer-events-none">
      ...
      <section className="relative py-32 px-8 bg-cream">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            {[
              { num: "I", title: "Niyet", text: "Kapı açık. Kilit yok. Bedel yok.\nSadece gir ve gör." },
              { num: "II", title: "Sebat", text: "Acele etme. Her gün bir damla.\nKendi ritminde. Sindire sindire." },
              { num: "III", title: "Vuslat", text: "On adımın sonunda.\nEski sen geride. Yeni bir yüz aynada." }
            ].map((step, i) => (
              <div key={i} className="reveal flex gap-10 py-10">
                <div className="w-[70px] h-[70px] bg-cream border-[3px] border-gold rounded-full flex items-center justify-center font-serif text-3xl text-teal shrink-0 relative z-10 shadow-[0_5px_20px_rgba(201,169,98,0.2)] transition-all duration-300 hover:bg-gold hover:text-cream hover:scale-110">
                  {step.num}
                </div>
                <div className="pt-2">
